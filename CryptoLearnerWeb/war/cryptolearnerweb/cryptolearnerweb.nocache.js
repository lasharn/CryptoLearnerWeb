...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cryptolearnerweb" because\n';
  ...
  $wnd.__gwt_activeModules['cryptolearnerweb'] = {
    'moduleName' : 'cryptolearnerweb',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/cryptolearnerweb.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cryptolearnerweb'].superdevmode = true;

  var expectedSuffix = '/cryptolearnerweb.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cryptolearnerweb + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cryptolearnerweb';
  var devModeSessionKey = '__gwtDevModeSession:cryptolearnerweb';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cryptolearnerweb/cryptolearnerweb.nocache.js';
  ...
  $wnd.__gwt_activeModules['cryptolearnerweb'].canRedirect = true;
  $wnd.__gwt_activeModules['cryptolearnerweb'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING cryptolearnerweb';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cryptolearnerweb?user.agent=' + ua + '&_callback=' + callback;
